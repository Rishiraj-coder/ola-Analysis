...
Import Bookings.csv into SQL Server table Bookings

Run SQLQuery1.sql file

🔹 Step 2: Power BI

Open ola dashboard.pbix

Connect to the SQL database (if needed)
...
Add predictive model for ride cancellation

Add time-series analysis for peak demand
